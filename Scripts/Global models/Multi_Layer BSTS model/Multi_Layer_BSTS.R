...
sz = dim(data.out)[1]
x11()
plot(1:168, pred, pch = 16, col = 'red', type ='o', xlab = 'day', ylab='traffic', main ='comparison between actual and predicted Y')
points(1:168, volume$Y, pch=15)
for(ii in 1:168)
{
...
x11()
plot(1:168, colMeans(pred_y), pch = 16, col = 'red', type ='o', xlab = 'day', ylab='traffic', main ='comparison between actual and predicted Y', lwd=2)
...
for(ii in 1:168)
{
  points(ii, quantile(pred_y[,ii], 0.05), col = 'darkred', pch = 16)
  points(ii, quantile(pred_y[,ii], 0.95), col = 'darkred', pch = 16)
  segments(ii, quantile(pred_y[,ii] , 0.05), ii, quantile(pred_y[,ii], 0.95), col  = 'darkred', lty=2)
  if(ii%%4==0)
  {
